...
let _ =
  Arg.parse [
    ...
    "-log", Arg.Set_string logfile, "\t\tChoose the trace file";
    ...
    "-ignore_parse_errors", Arg.Set Misc.ignore_parse_errors, "\tIgnore parse errors";
    "-stop_at_out_of_order_ts", Arg.Set Misc.stop_at_out_of_order_ts, "\tIgnore parse errors";
